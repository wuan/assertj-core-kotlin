...
class KotlinAssertionsTest {
    ...
    @Test
    fun shouldCreateJavaDurationAssert() {
        assertThat(assertThat(java.time.Duration.ofSeconds(1)).isNotNull).isInstanceOf(DurationAssert::class.java)
    }

    @Test
    fun shouldCreateKotlinDurationAssert() {
        assertThat(assertThat(1.seconds).isNotNull).isInstanceOf(DurationAssert::class.java)
    }    @Test
    fun shouldCreateInstantAssert() {
        assertThat(assertThat(Instant.now()).isNotNull).isInstanceOf(InstantAssert::class.java)
    }
}